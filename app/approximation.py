...
def fit_parameters(initial: ModelParameters | None = None, data_dir: Path | None = None) -> tuple[ModelParameters, List[ParsedSeries], PhaseDataset | None]:
    ...
    p0 = initial.as_array() if initial else np.array([1.0, 1.0, 1.84, 0.4, ALPHA_DEFAULT, 358.0], dtype=float)
    bounds = ([0.9, -100.0, 0.01, 0.01, 1e-5, 333.0], [1.1, 100.0, 100.0, 100.0, 0.05, 380.0])
