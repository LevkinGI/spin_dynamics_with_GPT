...
# Данные. Название: <Фиксированные поараметр(поле или температура)>_<его величина>. Строки: поле/температура, нч, вч, затухание нч, затухание вч.
T_293 = np.array([[1000, 1200, 1400, 1600, 1800, 2000],                                                      # Э (Oe)
                  [9.17440137,  9.423370201,  9.735918686,  10.01455683,  10.37994595,  10.5903492],         # ГГц
                  [29.35937721, 31.65155559,  30.2486405,   30.17815415,  29.94237192,  27.36357678],        # ГГц
                  [0.2326714,   0.2440502,    0.2528819,    0.2692589,	  0.2764174,    0.3013753],          # нс
                  [0.01385995,  0.01490037,   0.01370499,   0.01470922,   0.0150656,    0.02085652]])        # нс
...
H_1000 = np.array([[293, 298, 302, 308, 313, 318, 323, 328, 333],                                            # К
